...
//  PARM=(DLI,PART0001,PARTPSB1,7,0000,,0,,N,0,0,,,N,N,,N,)             00061024
...
//IEFRDER  DD DSN=IBMUSER.IMSLOG.IMSDB,DISP=(MOD,CATLG), >IMS LOG       00170020
//    SPACE=(CYL,(5,5),RLSE),UNIT=SYSDA,BLKSIZE=0                       00171020

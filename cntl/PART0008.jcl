...
//  PARM=(DLI,PART0007,PARTPSBA,7,0000,,0,,N,0,0,,,N,N,,N,)             00061023
...
//PARTDD01 DD DSN=IBMUSER.XIMS.KSDS.PARTDBD1,DISP=SHR  DATABASE         00140021
//PART1FLW DD DSN=IBMUSER.XIMS.ESDS.PARTDBD1,DISP=SHR                   00141021
//PROCLIB  DD DSN=IMS1010.PROCLIB,DISP=SHR                              00160000
//IEFRDER  DD DSN=IBMUSER.IMSLOG.IMSDB,DISP=(MOD,CATLG), >IMS LOG       00170019
//    SPACE=(CYL,(5,5),RLSE),UNIT=SYSDA                                 00171020

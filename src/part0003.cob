       ...
       FILE-CONTROL.                                                    00080000
           SELECT LOAD-INFILE  ASSIGN TO PARTDDIN                       00090009
       ...
       01 INPUT-RECORD-AREA.                                            00180005
          ...
          03 SEGMENT-IO-AREA PIC  X(16).                                00191005
       ...
       01 PRICSG05-QUAL-SSA.                                            00380000
         ...
         03 FIELD-VALUE-05  PIC   X(02)  VALUE SPACE.                   00430003
       ...
       01 PARTPCB-MASK.                                                 00470000
          ...
          03 CONCATED-KEY     PIC   X(16).                              00560000
       ...
       310-ISRT-PARTSG01-PARA.                                          00970000
           ...
           ELSE                                                         01050000
              ...
              DISPLAY 'KEY IS 01 '  PARTSG01-IO                         01061010
       ...
       320-ISRT-PRICSG05-PARA.                                          01242000
           ...
           IF STATUS-CODE = '  '                                        01249000
              DISPLAY 'PRICE SEGEMENT INSERT SUCCESFUL ' PART-NUM       01249100
              MOVE  PRICE-CODE   TO  FIELD-VALUE-05                     01249203
           ELSE                                                         01249300
              DISPLAY 'ERROR IN PRICE SEG ' STATUS-CODE                 01249400
              DISPLAY 'KEY IS 05 '  PARTSG01-IO                         01249510
              CALL WS-ABENDPGM                                          01249600
           END-IF.                                                      01249700
                                                                        01249800
       320-EXIT. EXIT.                                                  01249900
                                                                        01250000
       ...
       350-ISRT-ORDSEG15-PARA.                                          01702000
           ...
           IF STATUS-CODE = '  '                                        01709000
              DISPLAY 'ORDER SEGEMENT INSERT SUCCESFUL ' PART-NUM       01709100
           ELSE                                                         01709200
              DISPLAY 'ERROR IN ORDER SEG ' STATUS-CODE                 01709306
              DISPLAY 'KEY IS 15 '  PARTSG01-IO                         01709410
              CALL WS-ABENDPGM                                          01709500
           END-IF.                                                      01709600
                                                                        01709700
       350-EXIT. EXIT.                                                  01709800
                                                                        01710000
